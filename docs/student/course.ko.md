...
!!! note "Micro Learning"
    ...
    Minima LMS는 학습 객체들을 직접 사용할 수도 있고,
    과정에 포함 시켜서 학습할 수도 있습니다. 하나의 학습 객체를
    여러 방법으로 재사용 할 수 있도록 설계되었습니다.

!!! warning "학습 기록 추적"

    같은 학습 객체를 여러 방법으로 재사용할 때 학습 기록을 추적하는 데에는
    하나의 기록으로 볼 지, 위치마다 다른 기록으로 볼 지 문제가 발생합니다.
    Minima LMS는 학습 기록을 위치마다 별도로 저장하고 추적하여 완전히 격리합니다.
